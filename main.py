...
parser.add_argument('--top_k_aug', type=int, default=10, help="Top k number of sparsify")
...
parser.add_argument("--ax_i", type=int, default=0)
parser.add_argument("--ax_j", type=int, default=1)
